namespace SimulatedDevice
{
    ...
    {
        private const string IotHubUri = "iotliu.azure-devices.net";
        private const string DeviceKey = "2nN+P61COVMLLX7Xj2s4i0Lz3h4X/itn+ejLhECL9Wk=";
        private const string DeviceId = "dev001";
